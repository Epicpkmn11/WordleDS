...
public:
	...
	// Stats
	std::vector<int> guessCounts(void) const { return _guessCounts; }
	...
	std::vector<std::string> boardState(void) const { return _boardState; }
	...
	Config &streak(int streak) { _streak = streak; return *this; }
